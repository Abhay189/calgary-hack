  ...
  "node_modules/annyang/dist/annyang.min.js"(exports, module) {
    ...
    !function(e, n) {
      ...
      var a, c, s = [], u = { start: [], error: [], end: [], soundstart: [], result: [], resultMatch: [], resultNoMatch: [], errorNetwork: [], errorPermissionBlocked: [], errorPermissionDenied: [] }, f = 0, l = 0, d = false, p = "font-weight: bold; color: #00f;", g = false, m = false, h = /\s*\((.*?)\)\s*/g, y = /(\(\?:[^)]+\))\?/g, b = /(\(\?)?:\w+/g, v = /\*\w+/g, w = /[\-{}\[\]+?.,\\\^$|#]/g, S = function(e2) {
        for (var n = arguments.length, t2 = Array(1 < n ? n - 1 : 0), o2 = 1; o2 < n; o2++)
      ...
      return t = { init: function(e2) {
        ...
        a && a.abort && a.abort(), (a = new o()).maxAlternatives = 5, a.continuous = "http:" === r.location.protocol, a.lang = "en-US", a.onstart = function() {
          ...
          if (g)
            return d && k("Speech heard, but annyang is paused"), false;
          for (var n2 = e3.results[e3.resultIndex], t2 = [], o2 = 0; o2 < n2.length; o2++)
            t2[o2] = n2[o2].transcript;
          P(t2);
        ...
        for (var o2 in x(), e2)
          if (e2.hasOwnProperty(o2))
            if ("function" == typeof (n = r[e2[o2]] || e2[o2]))
              R((t2 = (t2 = o2).replace(w, "\\$&").replace(h, "(?:$1)?").replace(b, function(e3, n2) {
                return n2 ? e3 : "([^\\s]+)";
        ...
        for (var o2 in u)
          u.hasOwnProperty(o2) && (e2 !== i && e2 !== o2 || (u[o2] = n === i ? [] : u[o2].filter(t2)));
